...
<body>
    ...
    <div>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxDNI" ErrorMessage="El DNI no es correcto" ForeColor="Red" ValidationExpression="(([X-Z]{1})([-]?)(\d{7})([-]?)([A-Z]{1}))|((\d{8})([-]?)([A-Z]{1}))"></asp:RegularExpressionValidator>
        <br />
        <br />
